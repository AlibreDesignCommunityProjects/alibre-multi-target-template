...
## Overview
This repository contains the source and supporting assets for Alibre Multi Target Template, organized under the standardized repository layout.
...
- `source/AlibreXMultiTargetTemplate.sln`: key source or build entry point.
- `source/AlibreXMultiTargetTemplateCs/AlibreXMultiTargetTemplateCs.csproj`: key source or build entry point.
- `source/AlibreXMultiTargetTemplateFs/AlibreXMultiTargetTemplateFs.fsproj`: key source or build entry point.
- `source/AlibreXMultiTargetTemplateVb/AlibreXMultiTargetTemplateVb.vbproj`: key source or build entry point.
...
## Build and Use
1. Open `source/AlibreXMultiTargetTemplate.sln` in your preferred IDE.
